...
- [Change bone colors](https://www.youtube.com/watch?v=VqTdzPnvpUk) (Pose mode -> Object Data -> Add new bone group in "Bone Groups" -> Select color and assign the color to selected bones.
